...
public interface OauthService {
	 ...
	 * @throws IOException
	 */
	public void getAuthUrl(Map<String, String> request, HttpServletRequest httpRequest,
	 ...
	 * @throws IOException
	 */
	public void approveAuthorization(Map<String, String> request, HttpServletResponse response)
			throws IOException;
